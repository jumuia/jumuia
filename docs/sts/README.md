...
| AuthN                                                                                  | Description                                                                                                                                   |
| :----------------------                                                                | ------------------------------------------                                                                                                    |
| [**WebIdentity**](https://github.com/jumuia/jumuia/blob/master/docs/sts/web-identity.md) | Let users request temporary credentials using any OpenID(OIDC) compatible web identity providers such as KeyCloak, Dex, Facebook, Google etc. |
| [**AD/LDAP**](https://github.com/jumuia/jumuia/blob/master/docs/sts/ldap.md)             | Let AD/LDAP users request temporary credentials using AD/LDAP username and password.                                                          |
| [**AssumeRole**](https://github.com/jumuia/jumuia/blob/master/docs/sts/assume-role.md)   | Let MinIO users request temporary credentials using user access and secret keys.                                                              |
...
>
> - [**AssumeRole**](https://github.com/jumuia/jumuia/blob/master/docs/sts/assume-role.md)
> - [**AD/LDAP**](https://github.com/jumuia/jumuia/blob/master/docs/sts/ldap.md)
...
> NOTE: If you are interested in AssumeRole API only, skip to [here](https://github.com/jumuia/jumuia/blob/master/docs/sts/assume-role.md)

### Prerequisites

- [Configuring keycloak](https://github.com/jumuia/jumuia/blob/master/docs/sts/keycloak.md) or [Configuring Casdoor](https://github.com/jumuia/jumuia/blob/master/docs/sts/casdoor.md)
- [Configuring etcd](https://github.com/jumuia/jumuia/blob/master/docs/sts/etcd.md)
